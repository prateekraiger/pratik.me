        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          ...
          >
            <motion.div
              ...
              className="bg-slate-800/40 backdrop-blur-sm p-8 rounded-xl border border-[#915EFF]/30"
            >
            ...
            >
              <div className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-4 px-6 rounded-lg cursor-pointer transition-all duration-300 ease-in-out transform shadow-lg"
                >
                  Send Message
                </motion.button>
              </div>
              ...
              {success && (
                <motion.span
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="text-green-400 text-center block mt-6 p-4 bg-green-400/10 rounded-lg border border-green-400/30"
                >
              ...
              {error && (
                <motion.span
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="text-red-400 text-center block mt-6 p-4 bg-red-400/10 rounded-lg border border-red-400/30"
                >
