  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-black text-white font-sans overflow-hidden p-8 sm:p-16">
        {/* Grid Background */}
        <div className="absolute inset-0 w-full h-full bg-[linear-gradient(rgba(255,149,0,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(255,149,0,0.07)_1px,transparent_1px)] bg-[length:50px_50px] animate-[gridMove_20s_linear_infinite] z-0" />
        ...
        <div className="text-center max-w-3xl z-[10] relative">
          <h1 className="text-[clamp(2.5rem,5vw,4rem)] font-bold leading-tight mb-8">
            ...
            <span
              ...
              style={{
                backgroundImage:
                  "linear-gradient(45deg, #ff9500, #ffb347, #ffd700)",
...
export default function CtaPage() {
  return (
    <div className="bg-black">
      {" "}
      {/* Added bg-black here to ensure full page background if needed */}
      <AnimatedCTASection />
    </div>
  );
}
