...
// Custom component for "Pratik" text
function ApplePratikEffect({
  className,
  speed = 1,
  onAnimationComplete,
  ...props
  ...
  return (
    ...
    >
      ...
      {/* P - uppercase */}
      <motion.path
        d="M50 180 L50 40 L50 50 C50 40 70 30 90 30 C110 30 130 40 130 60 C130 80 110 90 90 90 L50 90"
      ...
      {/* r - lowercase */}
      <motion.path
        d="M160 180 L160 100 M160 120 C160 100 180 85 210 85"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(0.3),
          opacity: { duration: 0.2, delay: calc(0.3) },
        }}
      />

      {/* a - lowercase */}
      <motion.path
        d="M240 180 L270 100 L300 180 M250 140 L290 140"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* t - lowercase */}
      <motion.path
        d="M330 180 L330 85 M310 105 L350 105"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(0.9),
          opacity: { duration: 0.2, delay: calc(0.9) },
        }}
      />

      {/* i - lowercase */}
      <motion.path
        d="M380 180 L380 100 M380 85 L380 80"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* k - lowercase */}
      <motion.path
        d="M410 200 L410 85 M410 150 L450 115 M410 150 L450 180"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
...
// Custom component for "Raiger" text
function AppleRaigerEffect({
  className,
  speed = 1,
  onAnimationComplete,
  ...props
  ...
  return (
    ...
    >
      ...
      {/* R - uppercase */}
      <motion.path
        d="M50 180 L50 40 L50 50 C50 40 70 30 90 30 C110 30 130 40 130 60 C130 80 110 90 90 90 L50 90 M90 90 L130 180"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(2.0),
          opacity: { duration: 0.35, delay: calc(2.0) },
        }}
      />

      {/* a - lowercase */}
      <motion.path
        d="M160 180 L190 100 L220 180 M170 140 L210 140"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* i - lowercase */}
      <motion.path
        d="M250 180 L250 100 M250 85 L250 80"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(2.7),
          opacity: { duration: 0.15, delay: calc(2.7) },
        }}
      />

      {/* g - lowercase - Proper g shape with closed loop and descender */}
      <motion.path
        d="M280 140 C280 120 300 100 320 100 C340 100 360 120 360 140 C360 160 340 180 320 180 C300 180 280 160 280 140 M320 180 L360 180 L360 220 C360 240 340 260 320 260 C300 260 280 240 280 220"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(3.0),
          opacity: { duration: 0.4, delay: calc(3.0) },
        }}
      />

      {/* e - lowercase */}
      <motion.path
        d="M390 140 C390 120 410 100 430 100 C450 100 470 120 470 140 C470 160 450 180 430 180 C410 180 390 160 390 140 M390 140 L470 140"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(3.5),
          opacity: { duration: 0.3, delay: calc(3.5) },
        }}
      />

      {/* r - lowercase */}
      <motion.path
        d="M500 180 L500 100 M500 120 C500 100 520 85 550 85"
        style={{ strokeLinecap: "round", strokeLinejoin: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
